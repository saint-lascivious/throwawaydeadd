...
Those paths are `./hooks/pre_action` and `.hooks/post_action` for pre and post action hooks respectively. If found to be executable, any scripts in those directories will be executed in alphanumeric order.

...
The primary goal of `throwawaydeadd` is to make high availability, highly available.

## Features

- **Light Weight:** Principle of least operation.
...
- **DATE_FORMAT:** The date-time format yo be used in `throwawaydeadd` logs.
   ...
   | `locale` | Mon 14 Aug 2006 02:34:56 NZDT |
   | `epoch` | 1705996640 |
